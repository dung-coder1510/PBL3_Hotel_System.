...
namespace PBL3_Hotel_System_.Migrations
{
    ...
    [Migration("20260511144429_AddNgayThanhToanToBangLuong")]
    partial class AddNgayThanhToanToBangLuong
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PBL3_Hotel_System.Models.CaLam", b =>
                {
                    b.Property<int>("MaCa")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PBL3_Hotel_System.Models.DangKiCaLam", b =>
                {
                    b.Property<int>("MaDK")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PBL3_Hotel_System.Models.DangKiCaLam", b =>
                {
                    b.HasOne("PBL3_Hotel_System.Models.CaLam", "CaLam")
                        .WithMany()
                        .HasForeignKey("MaCa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
